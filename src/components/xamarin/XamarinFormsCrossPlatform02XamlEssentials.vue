...
&lt;/ContentPage&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-004.png"/>
                        <figcaption>Fig 02-004</figcaption>
                    </figure>
...
&lt;/StackLayout&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-007.png"/>
                ...
                <pre class="prettyprint"><code>void Handle_ValueChanged(object sender, Xamarin.Forms.ValueChangedEventArgs e)
{
    e.NewValue;
                    ...
                    <figure>
                        <img src="./images/02/Fig02-013.png"/>
...
private void InitializeComponent() {
    ...
    slider = global::Xamarin.Forms.NameScopeExtensions.FindByName&lt;global::Xamarin.Forms.Slider&gt;(this, &quot;slider&quot;);
                    ...
                    <figure>
                        <img src="./images/02/Fig02-018.png"/>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-020.png"/>
    ...
    StringFormat='Value is {0:F2}'}&quot; x:Name=&quot;label&quot;/&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-022.png"/>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-024.png"/>
...
<pre class="prettyprint"><code>&lt;Label BindingContext=&quot;{x:Reference slider}&quot;
    ...
    x:Name=&quot;label&quot;/&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-029.png"/>
...
&lt;/ContentPage&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-033.png"/>
                    ...
                    <p>Note that the BoxView is on top of the page just below the blue bar. Now if we run the same app in
                        iOS:</p>
                    <figure>
                        <img src="./images/02/Fig02-034.png"/>
...
&lt;/ContentPage.Padding&gt;</code></pre>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-052.png"/>
                    ...
                    <figure>
                        <img src="./images/02/Fig02-053.png"/>
