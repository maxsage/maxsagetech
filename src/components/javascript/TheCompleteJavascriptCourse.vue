      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <ol>
            ...
            <li>READ BEFORE YOU START!</li>
            <li>Setting up Our Tools</li>
          </ol>
          ...
          <ol start="4">
            ...
            <li>A Brief Introduction to JavaScript</li>
            ...
            <li>Boolean Logic</li>
            <li>The Ternary Operator and Switch Statements</li>
            <li>Truthy and Falsy Values and Equality Operators</li>
            <li>Coding Challenge 2</li>
            <li>Coding Challenge 2: Solution</li>
            <li>Functions</li>
            <li>Function Statements and Expressions</li>
            <li>Arrays</li>
            <li>Coding Challenge 3</li>
            <li>Coding Challenge 3: Solution</li>
            <li>Objects and Properties</li>
            <li>Objects and Methods</li>
            <li>Coding Challenge 4</li>
            <li>Coding Challenge 4: Solution</li>
            <li>Loops and Iteration</li>
            <li>Coding Challenge 5</li>
            <li>Coding Challenge 5: Solution, Part 1</li>
            <li>Coding Challenge 5: Solution, Part 2</li>
