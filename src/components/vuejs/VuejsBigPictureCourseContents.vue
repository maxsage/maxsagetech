          ...
          <ul>
            ...
            <li>
              ...
              <ol start="5">
                ...
                <li>A Simple Vue Application</li>
                <li>Where Should You Use Vue?</li>
                <li>Building Application as a Team and Prototyping with Vue</li>
              </ol>
            </li>
            <li>
                <a
              ...
              <ol start="10">
                ...
                <li>Managing State with Vuex</li>
                <li>Building Websites with Vuetify</li>
                <li>Scaffolding and Collaborating with Vue CLI</li>
                <li>Comparison to Existing Frameworks (Angular, React)</li>
                <li>Vue Pitfalls and Drawbacks</li>
              </ol>
            </li>
            <li>
                <a
