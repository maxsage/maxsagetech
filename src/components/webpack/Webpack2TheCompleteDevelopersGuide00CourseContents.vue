          ...
          <ul>
            ...
            <li>
              ...
              <ol start="3">
                ...
                <li>The Purpose of Webpack</li>
                <ul>
                <li>Quiz 1: Test Your Understanding</li>
                </ul>
                <li>Webpack in Action</li>
                <li>Javascript Module Syntax</li>
                <li>Linking Files with CommonJS</li>
                <li>Webpack Installation and Configuration</li>
                <li>More on Webpack Configuration</li>
                <li>Running Webpack</li>
                <li>The Bundle.js File</li>
            ...
            <li>
              ...
              <ol start="14">
                ...
                <li>Refactor to ES2015 Modules</li>
                <li>Handling CSS with WebPack</li>
                <li>The Style and CSS Loaders</li>
                <li>Loaders are Tricky!</li>
                <li>The Extract Text Plugin</li>
                <li>Handling Images with Webpack</li>
            ...
            <li>
              ...
              <ol start="44">
                ...
                <li>Deployment with Surge(Easiest!)</li>
                <li>Deployment with GithubPages</li>
                <li>Deployment with AWS S3</li>
              </ol>
            </li>
            <li>
              <a target="_blank"
              ...
              <ol start="49">
                ...
                <li>Webpack Middleware in Development</li>
                <li>Webpack Middleware in Production</li>
                <li>Deployment to Heroku</li>
                <li>Deployment to AWS</li>
                <li>More on AWS Deployment</li>
              </ol>
            </li>
            <li>
              <a target="_blank"
