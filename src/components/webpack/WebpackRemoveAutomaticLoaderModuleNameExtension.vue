<template>
  ...
  &quot;serve&quot;: &quot;node server.js&quot;
          ...
          <figure>
          <pre class="prettyprint">&quot;dev&quot;: &quot;cross-env NODE_ENV=development webpack-dev-server --open --inline --hot --port 8082&quot;,</pre>
  ...
  &quot;serve&quot;: &quot;node server.js&quot;
          ...
          <figure>
          <pre class="prettyprint">npm run dev</pre>
          ...
          append <code class="prettyprint">-loader</code>  to a module when the first module lookup failed.</p>
          <p>This meant in the <span class="filename">webpackconfig.json</span> code like this:</p>
          <figure>
  ...
  exclude: /node_modules/
          ...
          <figure>
          <pre>ERROR in multi (webpack)-dev-server/client?http://localhost:8082 webpack/hot/dev-server ./src/main.js
...
BREAKING CHANGE: It's no longer allowed to omit the '-loader' suffix when using loaders.
 ...
 @ multi (webpack)-dev-server/client?http://localhost:8082 webpack/hot/dev-server ./src/main.js
          ...
          <p>This is detailed in <a href="https://github.com/webpack/webpack/issues/2986">this feature
            request</a>.  I resolved this by appending <code class="prettyprint">-loader</code> to all the loader properties in the <span
