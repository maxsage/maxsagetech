<template>
    <ul class="nav nav-pills" style="margin-bottom: 10px">
        ...
        <router-link to="/javascript" tag="li" active-class="active"><a>Javascript</a></router-link>
        <router-link to="/nodejs" tag="li" active-class="active"><a>Node.js</a></router-link>
