        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <router-link to="/wpf-mvvm-in-depth-01-mvvm-pattern-fundamentals" active-class="active"><a>MVVM Pattern Fundamentals</a></router-link>
                    <p>
                    ...
                    <router-link to="/wpf-mvvm-in-depth-02-first-taste-of-mvvm" active-class="active"><a>First Taste Of MVVM</a></router-link>
                    ...
                    <router-link to="/wpf-mvvm-in-depth-03-hooking-up-views-and-viewmodels-in-mvvm" active-class="active"><a>Hooking up Views and ViewModels in MVVM</a></router-link>
                    <p>
                    ...
                    <router-link to="/wpf-mvvm-in-depth-04-view-viewmodel-communication-in-wpf" active-class="active"><a>View/ViewModel Communication in WPF</a></router-link>
                    <p>
                    ...
                    <router-link to="/wpf-mvvm-in-depth-05-applied-mvvm-part-1-hierarchies-and-navigation" active-class="active"><a>Applied MVVM Part 1 - Hierarchies and Navigation</a></router-link>
                    <p>
                    ...
                    <router-link to="/wpf-mvvm-in-depth-06-applied-mvvm-part-2-validation-and-dependency-injection" active-class="active"><a>Applied MVVM Part 2 - Validation and Dependency Injection</a></router-link>
                    <p>
