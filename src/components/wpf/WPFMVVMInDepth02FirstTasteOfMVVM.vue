        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <figure>
                <pre class="prettyprint"><code>namespace ZzaDashboard.Services
{
...
&lt;TextBox x:Name=&quot;lastNameTextBox&quot;
       ...
       Width=&quot;120&quot; /&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public partial class CustomerEditView : UserControl
{
    ...
    private Customer _customer = null;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>private async void OnLoaded(object sender, RoutedEventArgs e)
{
    ...
    phoneTextBox.Text = _customer.Phone;
                    ...
                    <figure>
                        <pre class="prettyprint"><code>_customer = await _repository.GetCustomerAsync(CustomerId);</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>private async void OnSave(object sender, RoutedEventArgs e)
{
    ...
    await _repository.UpdateCustomerAsync(_customer);
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;Customers:CustomerEditView CustomerId=&quot;11DA4696-CEA3-4A6D-8E83-013F1C479618&quot;
    HorizontalAlignment=&quot;Left&quot;
    Margin=&quot;42,35,0,0&quot;
    VerticalAlignment=&quot;Top&quot; /&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public static readonly DependencyProperty CustomerIdProperty =
...
private async void OnSave(object sender, RoutedEventArgs e)
{
    await _repository.UpdateCustomerAsync(_customer);
                    ...
                    <figure>
                        <pre class="prettyprint"><code>DataContext = _customer;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>await _repository.UpdateCustomerAsync(_customer);</code></pre>
    ...
    &lt;/Grid&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;UserControl xmlns=&quot;http://schemas.microsoft.com/winfx/2006/xaml/presentation&quot;
             xmlns:x=&quot;http://schemas.microsoft.com/winfx/2006/xaml&quot;
...
&lt;/UserControl.DataContext&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;Button x:Name=&quot;saveButton&quot;
    Content=&quot;Save&quot;
    Width=&quot;75&quot;
...
&lt;/i:Interaction.Triggers&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>&quot;{Binding}&quot;</code></pre>
...
&lt;/i:Interaction.Triggers&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public Customer Customer
{
    ...
    set
    {
        if (value != _customer)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Customer&quot;));
                    ...
                    <figure>
                <pre class="prettyprint"><code>public Guid CustomerId { get; set; }
public ICommand SaveCommand { get; set; }</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public CustomerEditViewModel()
{
    SaveCommand = new RelayCommand(OnSave);
                    ...
                    <figure>
                <pre class="prettyprint"><code>public async void LoadCustomer()
{
