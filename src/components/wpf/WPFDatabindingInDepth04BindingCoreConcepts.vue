...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex04-002"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
        ...
        <figure>
                <pre class="prettyprint">namespace Zza.Data
{
                ...
                <pre class="prettyprint">public class ZzaDbContext : DbContext
{
    ...
    public DbSet&lt;OrderStatus&gt; OrderStatuses { get; set; }</pre>
                ...
                <pre class="prettyprint">public MainWindow()
{
    ...
    DataContext = this;
        ...
        <figure>
                <pre class="prettyprint">private void OnDeleteCustomer(Customer customer)
{
    Customers.Remove(customer);
        ...
        <figure>
                <pre class="prettyprint">public RelayCommand&lt;Customer&gt; DeleteSelectedCommand
{
...
&lt;/DataGrid&gt;</pre>
        ...
        <figure>
          <pre class="prettyprint">&lt;Button Command=&quot;{Binding}&quot; Content=&quot;Delete&quot; /&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint">&lt;Button Command=&quot;{Binding
...
public static readonly DependencyProperty DeleteSelectedCommandProperty =
    ...
    new PropertyMetadata(null));</pre>
        ...
        <figure>
          <pre class="prettyprint">DeleteSelectedCommand = new RelayCommand&lt;Customer&gt;(OnDeleteCustomer, CanDeleteCustomer);</pre>
        ...
        <figure>
                <pre class="prettyprint">private bool CanDeleteCustomer(Customer customer)
{
    return customerDataGrid.SelectedItem != null;
        ...
        <figure>
                <pre class="prettyprint">private void customerDataGrid_SelectionChanged(object sender, SelectionChangedEventArgs e)
{
    DeleteSelectedCommand.RaiseCanExecuteChanged();
        ...
        <figure>
                <pre class="prettyprint">&lt;StackPanel Grid.Row=&quot;0&quot;
...
&lt;/Window.Resources&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint"> &lt;CollectionViewSource x:Key=&quot;customerViewSource&quot;
    Source=&quot;{Binding Path=Customers}&quot; /&gt;</pre>
    ...
    Path=DataContext.DeleteCustomerCommand}&quot;
        ...
        <figure>
          <pre class="prettyprint">&lt;Label Content=&quot;{Binding Path=Customers[0].Orders[1].OrderItems[0].Product.Name}&quot; /&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint"> using (ZzaDbContext context = new ZzaDbContext())
{
    Customers = new ObservableCollection&lt;Customer&gt;(context.Customers
                    .Include(&quot;Orders&quot;)
        ...
        <figure>
                <pre class="prettyprint">&lt;Button Content=&quot;Delete&quot;
    Command=&quot;{Binding DeleteSelectedCommandx}&quot;
    CommandParameter=&quot;{Binding ElementName=customerDataGrid, Path=SelectedItem}&quot; /&gt;</pre>
...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex04-010"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
    ...
    HorizontalAlignment=&quot;Left&quot;&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint"> &lt;TextBox x:Name=&quot;idTextBox&quot;
    Width=&quot;120&quot;
...
&lt;TextBox x:Name=&quot;nameTextBox&quot;
    ...
    Grid.Column=&quot;1&quot; /&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint">public string Name
{
    get
    {
        return _Name;
...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex04-012"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
        ...
        <figure>
                <pre class="prettyprint">&lt;UserControl x:Class=&quot;BindingProperties.MyCustomControl&quot;
...
&lt;/UserControl&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint">public MyCustomControl()
{
    InitializeComponent();
...
private static void OnBrushChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
    ((MyCustomControl)d).TheContent.Fill = e.NewValue as Brush;
        ...
        <figure>
                <pre class="prettyprint">public static readonly DependencyProperty MyBackgroundProperty =
    DependencyProperty.Register(&quot;MyBackground&quot;, typeof(Brush),
    typeof(MyCustomControl),
    new FrameworkPropertyMetadata(new SolidColorBrush(Colors.Gray),
        FrameworkPropertyMetadataOptions.BindsTwoWayByDefault,
        ...
        <figure>
                <pre class="prettyprint">private static void OnBrushChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
    ((MyCustomControl)d).TheContent.Fill = e.NewValue as Brush;
}</pre>
...
public Brush MyBackground
{
    ...
    set { SetValue(MyBackgroundProperty, value); }
        ...
        <figure>
                <pre class="prettyprint">&lt;local:MyCustomControl MyBackground=&quot;{Binding TheBrush}&quot;
    HorizontalAlignment=&quot;Left&quot;
    Height=&quot;74&quot;
    Margin=&quot;292,57,0,0&quot;
    VerticalAlignment=&quot;Top&quot;
    Width=&quot;105&quot; /&gt;</pre>
        ...
        <figure>
                <pre class="prettyprint"> public Brush TheBrush
{
...
public static readonly DependencyProperty TheBrushProperty =
    ...
    new PropertyMetadata(null, OnTheBrushChanged));
        ...
        <figure>
                <pre class="prettyprint">private static void OnTheBrushChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
}</pre>
