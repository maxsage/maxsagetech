        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;UserControl x:Class=&quot;ZzaDashboard.Customers.CustomerEditView&quot;
         Width=&quot;400&quot;
         Loaded=&quot;OnLoaded&quot;
         ...&gt;
...
&lt;/UserControl&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public partial class CustomerListView : UserControl
{
    public CustomerListView()
    {
        ...
        InitializeComponent();
                    ...
                    <p>Now before we dig into the MVVM let's go ahead and build this and I'll place an instance of my View
...
&lt;/Window&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public ObservableCollection&lt;Customer&gt; Customers { get; set; }</code></pre>
                    ...
                    <figure>
                    <pre class="prettyprint"><code>private ICustomersRepository _repo = new CustomersRepository();</code></pre>
                        <figcaption>Fig 03-001C</figcaption>
                    </figure>
                    <p>and a constructor to populate our Customers collection.</p>
                    <figure>
<pre class="prettyprint"><code>public CustomerListViewModel()
{
    Customers = _repo.GetCustomersAsync()
                    ...
                    <figure>
                        <pre class="prettyprint"><code>Customers = _repo.GetCustomersAsync()</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>Customers = _repo.GetCustomersAsync().Result;</code></pre>
                        <figcaption>Fig 03-001E</figcaption>
                    </figure>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>Customers = new ObservableCollection&lt;Customer&gt;(_repo.GetCustomersAsync().Result);</code></pre>
                    ...
                    <figure>
                    <pre class="prettyprint"><code>if(DesignerProperties.GetIsInDesignMode(
new System.Windows.DependencyObject())) return;</code></pre>
                    ...
                    <p>In the CustomerListView.xaml View add a namespace to bring in the Customers subfolder and the types
                        within it:
                    </p>
                    <figure>
                    <pre class="prettyprint"><code>xmlns:Class=&quot;MVVMHookupDemo.Customers.CustomerListView&quot;</code></pre>
...
&lt;/UserControl.DataContext&gt;</code></pre>
                    ...
                    <p>And with that we have MVVM hooked up. Now let's prove it by adding something in that actually shows
...
&lt;/Grid&gt;</code></pre>
                    ...
                    <p>Notice the binding for the DataGrid simply presumes that the DataContext is set in the standard MVVM
                    ...
                    <p>We can also hook-up the View and ViewModel from the code behind with code like this (comment out the
...
public CustomerListView()
{
    ...
    IntializeComponent();
                    ...
                    <p>Now we have the equation of MVVM satisfied through imperative code. We can run the application again
                    ...
                    <p>We start this demo from the end of the previous demo. Firstly, make sure you remove the DataContext
                    ...
                    <figure>
                <pre class="prettyprint"><code>namespace MVVMHookupDemo
{
    public static class ViewModelLocator
    {
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public static bool GetAutoWireViewModel(DependencyObject obj)</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public static bool GetMyProperty(DependencyObject obj)
{
...
public static readonly DependencyProperty MyPropertyProperty =
    ...
    new PropertyMetadata(false, MyPropertyChanged));</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>// Using a DependencyProperty as the backing store for MyProperty. This enables animation, styling, binding, etc...
public static readonly DependencyProperty MyPropertyProperty =
    DependencyProperty.RegisterAttached(&amp;quot;MyProperty&amp;quot;,
    typeof(bool), typeof(ViewModelLocator),
    new PropertyMetadata(false, MyPropertyChanged));</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public static readonly DependencyProperty AutoWireViewModelProperty =
DependencyProperty.RegisterAttached(&quot;AutoWireViewModel&quot;,
typeof(bool), typeof(ViewModelLocator),
new PropertyMetadata(false, AutoWireViewModelChanged));</code></pre>
                        <figcaption>Fig 03-008</figcaption>
                    </figure>
                    <p>Stub this method out:</p>
                    <figure>
                <pre class="prettyprint"><code>private static void AutoWireViewModelChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
    ...
    ((FrameworkElement)d).DataContext = viewModel;
                    ...
                    <figure>
                        <pre class="prettyprint">if (DesignerProperties.GetIsInDesignMode(d)) return;</code></pre>
                        <figcaption>Fig 03-009A</figcaption>
                    </figure>
                    <p>Next we need to get the ViewType name which we can do with a couple of lines of code:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>var viewType = d.GetType();
var viewTypeName = viewType.FullName;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>var viewModelTypeName = viewType + &quot;Model&quot;;
var viewModelType = Type.GetType(viewModelTypeName);</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>var viewModel = Activator.CreateInstance(viewModelType);</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>((FrameworkElement)d).DataContext = viewModel;</code></pre>
                    ...
                    <p>In the View add a namespace so that we can get to the ViewModelLocator type in the root of our
                        project:
                    </p>
                    <figure>
                        <pre class="prettyprint"><code>xmlns:local="clr-namespace:MVVMHookupDemo"</code></pre>
                        <figcaption>Fig 03-013A</figcaption>
                    </figure>
                    <p>Next on our root element which is the ViewType I add the AutoWireViewModel property:</p>
                    <figure>
                        <pre class="prettyprint"><code>local:ViewModelLocator.AutoWireViewModel=&quot;True&quot;</code></pre>
                    ...
                    <figure>
<pre class="prettyprint"><code>public CustomerDetailViewModel()
{
                    ...
                    <figure>
                        <pre class="prettyprint">xmlns:local="clr-namespace:MVVMHookupDemo"</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint">local:ViewModelLocator.AutoWireViewModel="True"</code></pre>
                    ...
                    <p>You can see that we are hitting the breakpoint in our ViewModel's constructor because it was auto
                    ...
                    <ul>
                        ...
                        <li>The View is not coupled to its particular ViewModel Type other than through the conventions of
                            the ViewModelLocator
                        </li>
                        <li>If that ViewModelLocator is written in a flexible way to be able to override those conventions
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;UserControl x:Class=&quot;...&quot; ...&gt;
    &lt;Grid&gt;
        ...
...
&lt;/UserControl&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public class CustomerEditViewModel
...
&lt;/Grid&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;DataGridTextColumn x:Name=&quot;firstNameColumn&quot;
                        Binding=&quot;{Binding FirstName}&quot;
                        Header=&quot;First Name&quot;
                        Width=&quot;SizeToHeader&quot; /&gt;
    &lt;DataGridTextColumn x:Name=&quot;lastNameColumn&quot;
...
<pre class="prettyprint"><code>public ObservableCollection&lt;Customer&gt; Customers
{
    ...
    set
    {
        customers = value;
                    ...
                    <p>Likewise, I'm going to drop into the Customer Model object type and find the FirstName property and
                        expand it:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>private string firstName;
...
public ObservableCollection&lt;Customer&gt; Customers
{
    ...
    set
    {
        _customers = value;
                    ...
                    <p>And then I'll drill down into that Customers repository to the GetCustomers method and set a
                        breakpoint here:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public Task&lt;List&lt;Customer&gt;&gt; GetCustomersAsync()
{
    return _context.Customers.ToListAsync();
}</code></pre>
                        <figcaption>Fig 03-015E</figcaption>
                    </figure>
                    <p>So if I start up now basically XAML parsing is happening, starting at the top and it's trying to
                        construct our ViewModel. So it comes into our ViewModel constructor now and it's trying to execute
                        this line of code:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>Customer = new ObservableCollection&lt;Customer&gt;(
    _repository.GetCustomersAsync().Result);
                </code></pre>
                        <figcaption>Fig03-015F</figcaption>
                    </figure>
                    <p>Which means it first has to go execute GetCustomersAsync. If I hit F5 to continue we'll hit the line
                        of code inside the repository that is doing an async call to the database to get the Customers back:
                    </p>
                    <figure>
                        <pre class="prettyprint"><code>return context.Customers.ToListAsync();</code></pre>
                        <figcaption>Fig03-015G</figcaption>
                    </figure>
                    <p>And then when that call completes, if I hit F5 again, now we see we're in the set block for our
...
&lt;DataGrid.Columns&gt;</code></pre>
                    ...
                    <p>on the ItemsSource that now needs to be resolved and is going to pull those Customers into the
                    ...
                    <p>because this DataGrid is editable by default we can see the bi-directional nature of the bindings
                        which allows us to communicate back down into those ViewModel Properties or Model Properties.
                    </p>

                    <p>In this case I'm going to set a break point on the set block of the Customer and we'll go ahead and
                    ...
                    <p>Now the way the DataGrid works by default is that I can tab off that field and it's going to buffer
                    ...
                    <p>So you can see that the data bindings to ViewModel Properties and to Model Properties form a
                    ...
                    <figure>
                    <pre class="prettyprint"><code>&lt;ContentControl Content="{Binding CurrentViewModel}" /&gt;</code></pre>
                        <figcaption>Fig03-015Q</figcaption>
                    </figure>
                    <p>When the property that is being bound on the control drives the rendered content on that control
                    ...
                    <p>the Control will go and look at the current Resource Dictionary that is in scope for the element and
                    ...
                    <p>which implicitly causes the construction of any Child elements. Then it renders that element as the
                    ...
                    <p>Which in this example means the DataContext of the Child View is set to its ViewModel marrying them
                    ...
                    <figure>
                <pre class="prettyprint"><code>public class CustomerListViewModel
{
...
&lt;/Grid.RowDefinitions&gt;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;ListBox Grid.Row=&quot;1&quot;
     ItemsSource=&quot;{Binding Customers}&quot; /&gt;</code></pre>
                    ...
                    <p>What's actually happening there is that when the binding gets the object it looks and sees if it's a
...
&lt;/UserControl.Resources&gt;</code></pre>
                    ...
                    <p>So we can see here this is just a DataTemplate containing a StackPanel. It's got a key of
                        CustomerTemplate. And then to actually use the template, we would go back to the ListBox and use the
                        ItemTemplate property:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>&lt;ListBox ItemsSource=&quot;{Binding Customers}&quot;
    ...
    Grid.Row=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>&lt;DataTemplate DataType=&quot;{x:Type data:Customer}&quot;&gt;</code></pre>
                        <figcaption>Fig 03-019</figcaption>
                    </figure>
                    <p>Using the x:Type markup extension here is very important. If you've been exposed to Silverlight or
                    ...
                    <figure>
                        <pre class="prettyprint"><code>xmlns:data=&quot;clr-namespace:Zza.Data;assembly=Zza.Data&quot;</code></pre>
                        <figcaption>Fig 03-020</figcaption>
                    </figure>
                    <p>And now when we run we still get the rendering of the Customers as we did before with their
                    ...
                    <p>Now we want to use DataTemplates to wire up our View and ViewModel. To do this you generally want to
...
&lt;Grid/&gt;</code></pre>
                    ...
                    <p>First step is to add a namespace for the root folder and then add our standard static XAML wire up of
...
&lt;/Grid&gt;</code></pre>
                    ...
                    <p>and that ContentControl's Content property is going to be bound to that CurrentViewModel property on
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;DataTemplate DataType=&quot;{x:Type Customers:CustomerListViewModel}&quot;&gt;
    &lt;Customers:CustomerListView /&gt;
&lt;/DataTemplate&gt;</code></pre>
                        <figcaption>Fig 03-021D</figcaption>
                    </figure>
                    <p>So if we just make the Content of the DataTemplate be a ViewType and map the DataType to it's
...
&lt;/Grid&gt;</code></pre>
                    ...
                    <p>Then the magic of implicit DataTemplates kicks in and as part of trying to render out this content it
                    ...
                    <p>Just one final reminder because I screw it up all the time myself. Make sure you use that x:Type
                    ...
                    <p>An example of this would be a Client Service that manages pop up dialogs to be presented to the user.
                    ...
                    <p>Most of the time you will be doing ViewModel-First or View-First depending on whether there's a
                    ...
                    <h2>Summary</h2>
                    <p>In this module I showed you a number of ways you can get your Views and ViewModels hooked up or
                    ...
                    <p>You saw how data binding forms the basic glue of MVVM including the DataContext being the ring that
                    ...
                    <p>You also saw that through the mechanisms of DataTemplates which themselves rely on data binding you
                    ...
                    <p>In the next module we'll take a look at how Views and ViewModels communicate with each other as
