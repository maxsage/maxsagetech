        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <h3>Introduction</h3>
                    <p>Hi, this is Brian Noyes, and in this module we're going to dive deeper into bindings and look at a
                        number of additional properties that let you unleash the full power of what a binding can do for you
                        for specialized scenarios.
                    </p>
                    <p>First up, we're going to look at a property called UpdateSourceTrigger, and this is a property on a
                    ...
                    <p>Next we're going to talk about Converters. Convertors give you a lot of power because it allows you
                    ...
                    <p>Next we'll talk about Async Bindings. Normally, bindings all happen on the UI thread, but sometimes
                    ...
                    <p>Then we'll talk about Fallback values and this is really two separate properties on a binding, one
                    ...
                    <p>Next we'll talk about FormatString. This is an automatic convertor of sorts, that lets you convert
                ...
                <div class="panel-body">
                    ...
                    <p>To do that, you can use a property on the binding called UpdateSourceTrigger. The default value is
                    ...
                    <p>Basically, Default and LostFocus mean the same thing for most controls. The one place they're
                    ...
                    <p>If you leave it on the default, then you're going to have to actually click on a separate row or tab
                ...
                <div class="panel-body">
                    ...
                    <div class="example">
                        <div class="input-group">
                            <input id="Ex05-001" type="text" class="form-control"
                                   value="C:\Development Tutorials\Pluralsight-Courses\WPF Data Binding in Depth\Module 5\before\BindingProperties\BindingProperties.sln">
                    ...
                    <div class="example">
                        <div class="input-group">
                            <input id="Ex05-002" type="text" class="form-control"
                                   value="C:\Development Tutorials\Pluralsight-Courses\WPF Data Binding in Depth\Module 5\after\BindingProperties\BindingProperties.sln">
                            <span class="input-group-btn">
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-001.png" class="image"/>
                        <figcaption>Fig 04-001</figcaption>
                    </figure>
                    <p>That is the default UpdateSourceTrigger for most bindings. I'm going to drop into the XAML here and
                        add a couple of Labels and TextBoxes which we can show up down here as Source and Target, two
                        different TextBoxes.
                    </p>

                    <figure>
                <pre class="prettyprint"><code>&lt;TextBox x:Name=&quot;SourceTextBox&quot;
...
&lt;TextBox x:Name=&quot;TargetTextBox&quot;
    ...
    Width=&quot;120&quot; /&gt;</code></pre>
                    ...
                    <p>The Target TextBox has its text bound, but it's using an ElementName binding, which we covered
                    ...
                    <figure>
                        <pre class="prettyprint"><code>Path=Text, UpdateSourceTrigger=PropertyChanged}</code></pre>
                        <figcaption>Fig 04-004</figcaption>
                    </figure>
                    <p>If I leave it on Default:</p>
                    <figure>
                        <pre class="prettyprint"><code>Path=Text, UpdateSourceTrigger=Default}</code></pre>
                        <figcaption>Fig 04-005</figcaption>
                    </figure>
                    <p>once I start putting stuff in the Source, you can see that the Target stays in synch on every
                        keystroke:
                    </p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-006.png" class="image"/>
                        <figcaption>Fig 04-006</figcaption>
                    </figure>
                    <p>However, if I go to the Target and start putting stuff in, the Source does not update until I tab out
                    ...
                    <figure>
                <pre class="prettyprint"><code>TextBox x:Name="TargetTextBox"
                    ...
                    <p>It basically says, every time the Target property changes, which is the Text property of this
                        TextBox, go ahead and push its current value down into the source object's property.
                    </p>

                    <p>So now we're going to get fully synchronized if we start up. Source is raising PropertyChanged on
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-008.png" class="image"/>
                        <figcaption>Fig 04-008</figcaption>
                    </figure>
                    <p>So basically, when you want the source set immediately every time the bound property changes, then
                    ...
                    <p>There's Default and LostFocus, which for most controls mean exactly the same thing, lost focus. The
                    ...
                    <p>We covered PropertyChanged. Explicit is a mode where you actually have to use programmatic call
                ...
                <div class="panel-body">
                    ...
                    <p>You can transform just the value using the same type, so in a numeric scenario maybe you would round
                    ...
                    <p>The way you define a convertor is by creating a class that implements the IValueConverter interface.
                    ...
                    <p>So basically, you just implement this interface on a class, you put an instance of that class in a
                ...
                <div class="panel-body">
                    ...
                    <p>In this demo, I want to show you how you can use converters with bindings to change the value that
                        gets set through a binding or to change the type entirely.
                    </p>
                    <p>For our first scenario, let's say that anytime you want to display negative numbers in a form, you
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-010.png" class="image"/>
                        <figcaption>Fig 04-010</figcaption>
                    </figure>
                    <p>To implement a Converter, you're going to want it to be public so it can be called by the framework,
                    ...
                    <figure>
                <pre class="prettyprint"><code>public class NegativeNumberConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        throw new NotImplementedException();
                    ...
                    <p>Convert gets called as data is flowing from the source to the target. The value that is going to be
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        if (value.ToString().StartsWith(&quot;(&quot;) &amp;&amp; value.ToString().EndsWith(&quot;)&quot;))
        {
            return -int.Parse(value.ToString().Substring(1, value.ToString().Length - 2));
                    ...
                    <p>and you can see what the implementation does here, is it's expecting this to only be hooked up to
                    ...
                    <p>But here we're assuming we're only going to be hooked up to integers. We cast to an integer and we
                    ...
                    <p>If we're going to support two-way data binding and allow people to enter negative numbers with
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
{
    if (value.ToString().StartsWith(&quot;(&quot;) &amp;&amp; value.ToString().EndsWith(&quot;)&quot;))
    {
        return -int.Parse(value.ToString().Substring(1, value.ToString().Length - 2));
                    ...
                    <p>We're basically going to strip those off and negate the value that's there to return the negative
                        integer down to the source object.
                    </p>
                    <p>Now to use this converter I need to create an instance of it and use it in a binding. So I'm going to
...
&lt;/Window.Resources&gt;</code></pre>
                    ...
                    <p>So then we're going to drop down into the form here to the field that we have that's a numeric value,
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;TextBox x:Name=&quot;ageTextBox&quot;
     Width=&quot;120&quot;
     ...
     Grid.Column=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <p>Anytime data is flowing from the source to the target, it's going to call the Convert method, and
                        then if we edit this and push a value down through, it's going to invoke the ConvertBack method on
                        that converter.
                    </p>
                    <p>With that in place, we can go back here to where our Customer is being initialized and we'll set the
                        Age property as -35 there:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>Customer = new Customer
{
    Id = 42,
    Name = &quot;Joe&quot;,
    ...
    Age = -35
                    ...
                    <p>I'll go over to the Age property on my Customer object and set a breakpoint so we can see when it's
                        being set what it's being set to.
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public int Age
{
    get
    {
        return _Age;
    ...
    set
    {
        if (value != _Age) // Set breakpoint here
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Age&quot;));
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-019.png" class="image"/>
                        <figcaption>Fig 04-019</figcaption>
                    </figure>
                    <p>and we see it renders out with parentheses instead of the -35.</p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-020.png" class="image"/>
                        <figcaption>Fig 04-020</figcaption>
                    </figure>
                    <p>And if we put in some other values, such as (99), and tab out of the field, our set block gets called,
                        and the current value is -99:
                    </p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-021.png" class="image"/>
                        <figcaption>Fig 04-021</figcaption>
                    </figure>
                    <p>so it strips off those parentheses and turns it into an actual negative integer.</p>
                    <p>Now as another example, let's say we want to set a style based on a Boolean property in our model.
                        I'm going to add a BoolToStyle Converter class and I'll quickly flesh out the implementation:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public class BoolToStyleConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
    ...
    Style GetStyle(string key)
    {
        return Application.Current.Resources[key] as Style;
                    ...
                    <p>You can see what this is doing is it's doing a little more type checking, so it's saying, if the
                    ...
                    <p>And for a starting point here, it's going to say, I could hard code here a style name of TrueStyle
                        and FalseStyle corresponding to those Boolean values:
                    </p>
                    <figure>
                <pre class="prettyprint"><code> if (targetType == typeof(Style) && value is bool)
{
    if ((bool)value) { return GetStyle(styles[0]); }
                    ...
                    <figure>
                <pre class="prettyprint"><code>Style GetStyle(string key)
{
    return Application.Current.Resources[key] as Style;
}</code></pre>
                    ...
                    <p>Then I'm just going to return that as the value that actually gets set on the target of the
                        binding.
                    </p>
                    <figure>
                <pre class="prettyprint"><code>if ((bool)value) { return GetStyle(styles[0]); }
else { return GetStyle(styles[1]); }</code></pre>
                        <figcaption>Fig 04-025</figcaption>
                    </figure>
                    <p>Based on that code, I'll need those styles to exist so I'll go out of here to my
                    ...
                    <figure>
                <pre class="prettyprint"><code>&lt;Application x:Class=&quot;BindingProperties.App&quot;
...
&lt;/Application&gt;</code></pre>
                    ...
                    <p>Now to use that in my application, I would go to my MainWindow to the Resources, and create an
    ...
    Grid.Column=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <p>So I'm pointing to a Boolean property on my model called premium customer and then I'm using my
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-028.png" class="image"/>
                        <figcaption>Fig 04-028</figcaption>
                    </figure>
                    <p>If I uncheck it, it goes to black and back to red.</p>
                    <p>Now obviously hard-coding Style names down inside some code like this is not a great idea, and that's
                        where this object parameter can come in.
                    </p>
                    <figure>
                        <pre class="prettyprint"><code>public object Convert(object value, Type targetType, object parameter, CultureInfo culture)</code></pre>
                        <figcaption>Fig 04-029</figcaption>
                    </figure>
                    <p>You can pass ConverterParameters to a converter to drive its behavior. So if I modify that
                        implementation a little bit, and I expect my parameter to be a semi-colon separated pair of Style
                        names:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>string[] styles = parameter.ToString().Split(';');
if (targetType == typeof(Style) &amp;&amp; value is bool)
{
    if ((bool)value) { return GetStyle(styles[0]); }
    else { return GetStyle(styles[1]); }
                    ...
                    <p>I can split that out into an array and then use the first one as my TrueStyle and the second one as
                        my FalseStyle.
                    </p>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>Converter={StaticResource BoolToStyleConverter}, ConverterParameter=TrueStyle;FalseStyle}</code></pre>
                    ...
                    <p>But now this BoolToStyleConverter is a little more reusable because you can pass in those two
                ...
                <div class="panel-body">
                    <h3>Async Binding</h3>
                    <p>Most of the time you're binding, you're going to be binding to objects in memory that have already
                    ...
                    <p>So a binding is calling the get and set block of the property it's bound to, and it does that on the
                        UI thread in a synchronous manner by default.
                    </p>
                    <p>Now one thing to be aware of is that in WPF your source objects can raise PropertyChanged on a
                    ...
                    <p>In WPF that's okay. The binding is actually smart enough to see that you're not on the UI thread,
                    ...
                    <p>Another form of Async the bindings support, is setting a Delay on when the binding can call the set
                ...
                <div class="panel-body">
                    ...
                    <p>In this demo, I want to show you how you can use the Async capabilities of bindings. Now in most
                    ...
                    <figure>
                <pre class="prettyprint"><code>public string Phone
{
    get
    {
        return _Phone;
    ...
    set
    {
        if (value != _Phone)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Phone&quot;));
                    ...
                    <p>But depending on the way you structure things, you may have setters and getters on a given property
                ...
                <pre class="prettyprint"><code>public string Phone
{
    ...
    set
    {
        ...
        if (value != _Phone)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Phone&quot;));
                    ...
                    <p>And if I did that without doing anything else and tried to run, first off, we can see as it starts up
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-035.png" class="image"/>
                        <figcaption>Fig 04-035</figcaption>
                    </figure>
                    <p>Likewise, if we go and change that field and tab out of the field, you can see the cursor didn't
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-036.png" class="image"/>
                    ...
                    <p>So all you would do to leverage Async bindings, is go to the binding on the property that you want to
                        be Async and say, IsAsync=True:
                    </p>
                    <figure>
                <pre class="prettyprint"><code> &lt;TextBox x:Name=&quot;phoneTextBox&quot;
    Width=&quot;120&quot;
    VerticalAlignment=&quot;Center&quot;
    ...
    Grid.Column=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <p>Now, if we start up our same exact scenario, you can see the UI comes up and is responsive right
                        away:
                    </p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-038.png" class="image"/>
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-039.png" class="image"/>
                        <figcaption>Fig 04-039</figcaption>
                    </figure>
                    <p>And, likewise, if we modify it and tab out of the field, it just goes blank and we can be using the
                        rest of the UI until the point where the Phone set block completes and the value pops back in there.
                    </p>
                    <p>So it just makes it a non-blocking thing the WPF is going to actually go use a background thread to
                    ...
                    <p>The other thing to be aware of is that if you have multiple threads in your application and a
                    ...
                    <p>So another binding property related to Async that you might use in some scenarios is the Delay
    ...
    Width=&quot;120&quot; /&gt;</code></pre>
                    ...
                    <p>So I could add Delay=500, and that's in ms, on my two TextBoxes that are bound to each other down
                    ...
                    <p>So with that in place, we can see the visual impact of this behavior. If I go down here to my source,
                        I start setting things there in sync. I go to my target and I rapidly input some stuff:
                    </p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-041.png" class="image"/>
                        <figcaption>Fig 04-041</figcaption>
                    </figure>
                    <p>500 ms later, it fills in the source and it only set the source one time in that case at the 500 ms
                        point. Do it again, and 500 ms later, one set of the source happens, not one for each character that
                        I was setting.
                    </p>
                    <p>So this is handy for situations like this if you may have some very rapid input, especially if you're
                ...
                <div class="panel-body">
                    ...
                    <p>Another minor capability of bindings you should be aware of is the ability to supply some fallback
                    ...
                    <p>So you basically supply a value in the binding that's going to be used to set the target property if
                        the current value of the source property is null.
                    </p>
                    <p>The other one is literally called FallbackValue, and this one is used when the binding can't come up
        ...
        Style=&quot;{Binding Path=PremiumCustomer,
         ...
         Grid.Column=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <p>What TargetNullValue means, the name is a little misleading there, it's really if the source value is
                ...
                <pre class="prettyprint"><code>private void Window_Loaded(object sender, RoutedEventArgs e)
{
    Customer = new Customer
    {
        ...
        Age = -35
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-044.png" class="image"/>
                        <figcaption>Fig 04-044</figcaption>
                    </figure>
                    <p>So because of the value that the binding came up with was equal to null, and we had the
                    ...
                    <figure>
                    <pre><code
                            class="xml">{Binding Path=Name, TargetNullValue='Not set', FallbackValue='no value'}</code></pre>
                        <figcaption>Fig 04-045</figcaption>
                    </figure>
                    <p>This will be used when the binding is unable to come up with a value at all based on the Path that
                    ...
                    <p>and I run, now we see no value in there because the binding was unable to evaluate and come up with a
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-047.png" class="image"/>
                        <figcaption>Fig 04-047</figcaption>
                    </figure>
                    <p>So you always want to be looking for those. In this case, it was a warning, not an error, because we
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-048.png" class="image"/>
                        <figcaption>Fig 04-048</figcaption>
                    </figure>
                    <p>So those are TargetNullValue used when the Source property is null, and gives a value to set on the
                        target and FallbackValue when it can't resolve a value from the specified binding Path.
                    </p>
                </div>
                <div class="panel-body">
                    <h3>StringFormat</h3>
                    <p>StringFormat is a handy property on bindings for being able to render out a formatted value in the
                    ...
                    <p>There are a number of built-in format strings for things like dates and numeric formats, and you can
                ...
                <div class="panel-body">
                    ...
                    <div class="example">
                        <div class="input-group">
                            <input id="Ex05-009" type="text" class="form-control"
                                   value="C:\Development Tutorials\Pluralsight-Courses\WPF Data Binding in Depth\Module 5\before\BindingProperties\BindingProperties.sln">
                            <span class="input-group-btn">
                	        <button class="btn" data-clipboard-target="#Ex05-009">
                        	    <img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard">
                            </button>
        	            </span>
                        </div>
                    ...
                    <div class="example">
                        <div class="input-group">
                            <input id="Ex05-010" type="text" class="form-control"
                                   value="C:\Development Tutorials\Pluralsight-Courses\WPF Data Binding in Depth\Module 5\after\BindingProperties\BindingProperties.sln">
                            <span class="input-group-btn">
                	        <button class="btn" data-clipboard-target="#Ex05-010">
                        	    <img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard">
                            </button>
        	            </span>
                        </div>
                    </div>
                    <p>In this demo, I want to show you quickly how to use the StringFormat property on a binding to render
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-049.png" class="image"/>
                ...
                <pre class="prettyprint"><code>public class Customer : INotifyPropertyChanged
{
    ...
    private int _Id;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>public float Age2
{
    get
    {
        return _Age2;
    ...
    set
    {
        if (value != _Age2)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Age2&quot;));
                    ...
                    <p>Then I'm going to drop into the UI and find the Age input, and I'm going to replace that with a
...
Grid.Column=&quot;1&quot; /&gt;</code></pre>
                    ...
                    <p>So here we can see we're still binding to the Age Property, but now we just simply set the
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-053.png" class="image"/>
                        <figcaption>Fig 04-053</figcaption>
                    </figure>
                    <p>Now let's go set a breakpoint in the set block and do that again, and we'll say 44.4455, tab out, and
                        we can see the value that's being set is the full precision value:
                    </p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-054.png" class="image"/>
                        <figcaption>Fig 04-054</figcaption>
                    </figure>
                    <p> but when we run, all we see is the rounded off value applied by StringFormat:</p>
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-055.png" class="image"/>
                        <figcaption>Fig 04-055</figcaption>
                    </figure>
                    <p>So one downside to using these is to realize that what you see on the screen and what the actual
                    ...
                    <figure>
                    <pre><code
                            class="xml">{Binding Path=Age, StringFormat=f2, UpdateSourceTrigger=PropertyChanged}}</code></pre>
                        <figcaption>Fig 04-056</figcaption>
                    </figure>

                    <p>and go run our scenario again, now watch what happens as I put in a value. I hit 5, and it
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-057.png" class="image"/>
                        <figcaption>Fig 04-057</figcaption>
                    </figure>
                    <p>The source property raises a PropertyChangedEvent, that forces the binding to re-bind and re-render
                    ...
                    <figure>
                        <img src="./images/wpfdatabindingindepth/Fig04-058.png" class="image"/>
                        <figcaption>Fig 04-058</figcaption>
                    </figure>
                    <p>It's because after each keystroke it's re-rendering, it's putting the decimal place in there for me,
                    ...
                    <p>As a result of that, you generally don't want to use UpdateSourceTrigger=PropertyChanged in
                ...
                <div class="panel-body">
                    ...
                    <p>One last topic I want to touch on in this module is the concept of MultiBindings and
                    ...
                    <p>But this MultiValueConverter is going to get passed an array of values. The array is going to be
                    ...
                    <p> The other kind of binding is called a PriorityBinding, and it's somewhat similar in that it can
                    ...
                    <p>Now I'm not even going to do a demo of these, because generally, in many years of doing WPF
                    ...
                    <p>Generally the alternative is to go produce a single value behind the scenes and put it into a source
                ...
                <div class="panel-body">
                    <h3>Summary</h3>
                    <p>So in this module we covered a bunch of fine-grain control points that you have when you apply
                    ...
                    <p>We also talked about the difference between Default and LostFocus. Default and LostFocus generally
                    ...
                    <p>Next we talked about Async bindings and simply using the IsAsync property on a binding to make it so
                    ...
                    <p>Finally, we finished off with the concept surrounding MultiBindings and PriorityBindings. We
...
<script>
    export default {
        name: "WPFDatabindingInDepth05UnleashingTheFullPowerOfBindings.vue"
    }
</script>
