...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex05-002"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
          ...
          <figure>
                <pre class="prettyprint">&lt;TextBox x:Name=&quot;SourceTextBox&quot;
...
&lt;TextBox x:Name=&quot;TargetTextBox&quot;
    ...
    Width=&quot;120&quot; /&gt;</pre>
          ...
          <figure>
            <pre class="prettyprint">Path=Text, UpdateSourceTrigger=PropertyChanged}</pre>
            <figcaption>Fig 04-004</figcaption>
          </figure>
          <p>If I leave it on Default:</p>
          <figure>
            <pre class="prettyprint">Path=Text, UpdateSourceTrigger=Default}</pre>
          ...
          <figure>
                <pre class="prettyprint">TextBox x:Name="TargetTextBox"
                    Text="{Binding ElementName=SourceTextBox,
                    Path=Text, UpdateSourceTrigger=PropertyChanged}"</pre>
...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex05-004"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
          ...
          <figure>
                <pre class="prettyprint">public class NegativeNumberConverter : IValueConverter
{
                ...
                <pre class="prettyprint">public class NegativeNumberConverter : IValueConverter
{
    ...
    public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
    {
        if (value.ToString().StartsWith(&quot;(&quot;) &amp;&amp; value.ToString().EndsWith(&quot;)&quot;))
        {
          ...
          <figure>
            <pre class="prettyprint">public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)</pre>
          ...
          <figure>
                <pre class="prettyprint">public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
{
    if (value.ToString().StartsWith(&quot;(&quot;) &amp;&amp; value.ToString().EndsWith(&quot;)&quot;))
    {
        return -int.Parse(value.ToString().Substring(1, value.ToString().Length - 2));
...
&lt;/Window.Resources&gt;</pre>
          ...
          <figure>
                <pre class="prettyprint">&lt;TextBox x:Name=&quot;ageTextBox&quot;
     Width=&quot;120&quot;
     ...
     Grid.Column=&quot;1&quot; /&gt;</pre>
          ...
          <figure>
                <pre class="prettyprint">Customer = new Customer
{
    Id = 42,
    Name = &quot;Joe&quot;,
    ...
    Age = -35
          ...
          <figure>
                <pre class="prettyprint">public int Age
{
    get
    {
        return _Age;
    ...
    set
    {
        if (value != _Age) // Set breakpoint here
        {
          ...
          <figure>
                <pre class="prettyprint">public class BoolToStyleConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
    ...
    Style GetStyle(string key)
    {
        return Application.Current.Resources[key] as Style;
          ...
          <figure>
                <pre class="prettyprint"> if (targetType == typeof(Style) && value is bool)
{
    if ((bool)value) { return GetStyle(styles[0]); }
          ...
          <figure>
                <pre class="prettyprint">Style GetStyle(string key)
{
    return Application.Current.Resources[key] as Style;
}</pre>
          ...
          <figure>
                <pre class="prettyprint">if ((bool)value) { return GetStyle(styles[0]); }
else { return GetStyle(styles[1]); }</pre>
          ...
          <figure>
                <pre class="prettyprint">&lt;Application x:Class=&quot;BindingProperties.App&quot;
...
&lt;/Application&gt;</pre>
          ...
          <figure>
                <pre class="prettyprint">&lt;TextBox x:Name=&quot;nameTextBox&quot;
    ...
    Grid.Column=&quot;1&quot; /&gt;</pre>
          ...
          <figure>
            <pre class="prettyprint">public object Convert(object value, Type targetType, object parameter, CultureInfo culture)</pre>
          ...
          <figure>
                <pre class="prettyprint">string[] styles = parameter.ToString().Split(';');
if (targetType == typeof(Style) &amp;&amp; value is bool)
{
    if ((bool)value) { return GetStyle(styles[0]); }
    else { return GetStyle(styles[1]); }
          ...
          <figure>
            <pre class="prettyprint">Converter={StaticResource BoolToStyleConverter}, ConverterParameter=TrueStyle;FalseStyle}</pre>
...
<span class="input-group-btn"><button class="btn" data-clipboard-target="#Ex05-006"><img src="/./src/assets/clippy.svg" width="13" alt="Copy to clipboard"></button></span>
          ...
          <figure>
                <pre class="prettyprint">public string Phone
{
    get
    {
        return _Phone;
                ...
                <pre class="prettyprint">public string Phone
{
    ...
    set
    {
        ...
        if (value != _Phone)
        {
          ...
          <figure>
                <pre class="prettyprint"> &lt;TextBox x:Name=&quot;phoneTextBox&quot;
    Width=&quot;120&quot;
    VerticalAlignment=&quot;Center&quot;
                ...
                <pre class="prettyprint">private void Window_Loaded(object sender, RoutedEventArgs e)
{
    Customer = new Customer
    {
        ...
        Age = -35
          ...
          <figure>
                    <pre class="prettyprint">{Binding Path=Name, TargetNullValue='Not set', FallbackValue='no value'}</pre>
                ...
                <pre class="prettyprint">public class Customer : INotifyPropertyChanged
{
    ...
    private int _Id;</pre>
          ...
          <figure>
                <pre class="prettyprint">public float Age2
{
    get
    {
        return _Age2;
...
Grid.Column=&quot;1&quot; /&gt;</pre>
          ...
          <figure>
                    <pre class="prettyprint">{Binding Path=Age, StringFormat=f2, UpdateSourceTrigger=PropertyChanged}}</pre>
