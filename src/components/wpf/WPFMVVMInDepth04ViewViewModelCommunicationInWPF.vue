        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <figure>
                        <img src="./images/wpfmvvmindepth/Fig04-001.png"/>
                    ...
                    <p>With this definition we expect to have a DeleteCommand property of type ICommand exposed from our
                        ViewModel and as the XAML gets parsed here several things are going to happen.
                    </p>
                    <ul>
                        <li>First it's going to call the get block on that ICommand Property to get a reference to the
                            Command object.
                        </li>
                        <li>Then it's going to call CanExecute() on that Command to determine the initial enabled or
                            disabled state of the Command and it will enable or disable the Button as a result.
                        </li>
                        <li> Then it will subscribe to CanExecuteChanged on that ICommand. This will allow us to be notified
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public ICommand DeleteCommand { get; private set; }</code></pre>
...
{</pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>bool ICommand.CanExecute(object parameter)
{
...
void ICommand.Execute(object parameter)
{
    if (_TargetExecuteMethod != null)
    {
        _TargetExecuteMethod();
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public RelayCommand DeleteCommand { get; private set; }</code></pre>
                        <figcaption>Fig 05-005A</figcaption>
                    </figure>
                    <p>Now we need to construct an instance and put it into that property; we will do this in the
                        constructor.
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public CustomerListViewModel()
{
    ...
    DeleteCommand = new RelayCommand(OnDelete,CanDelete);
                    ...
                    <figure>
                <pre class="prettyprint"><code>private void OnDelete()
{
...
private bool CanDelete()
{
    return true;
                    ...
                    <figure>
                <pre class="prettyprint"><code>private Customer _selectedCustomer;
public Customer SelectedCustomer
{
    ...
    set
    {
        _selectedCustomer = value;
                    ...
                    <p>So I've added a new SelectedCustomer property and we can go over to the View now and set it up so
    ...
    &lt;DataGrid.Columns&gt;
        ...
        &lt;DataGridTextColumn Binding=&quot;{Binding LastName}&quot;
                    ...
                    <p>Now the ViewModel will always be in tune with what the selection is and it can use that as the
                        context for the Command.
                    </p>
                    <p>So now I can drop back over to the ViewModel to the OnDelete method and simply remove the
...
private bool CanDelete()
{
    return SelectedCustomer != null;
                    ...
                    <figure>
                <pre class="prettyprint"><code>private bool CanDelete()
{
    return SelectedCustomer != null;
}</code></pre>
                    ...
                    <p>In the ViewModel we know that the SelectedCustomer is going to be set through our other binding so if
                ...
                <pre class="prettyprint"><code>set
{
    ...
    DeleteCommand.RaiseCanExecuteChanged();
                    ...
                    <p>Lastly we will hook-up input gestures to trigger your bindings such as keyboard shortcuts. In the
                        View add InputBindings as a collection on the Root element.
                    </p>
                    <figure>
                <pre class="prettyprint"><code>&lt;UserControl.InputBindings&gt;
    &lt;KeyBinding Key=&quot;D&quot;
                Modifiers=&quot;Control&quot;
                Command=&quot;{Binding DeleteCommand}&quot; /&gt;
&lt;/UserControl.InputBindings&gt;</code></pre>
                    ...
                    <p>Next use the propa Visual Code snippet that is built into Visual Studio to create an Attached
                        Property called LoadedMethodName. Make it of type string:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public static class MvvmBehaviors
{
    ...
    public static readonly DependencyProperty LoadedMethodNameProperty =
        ...
        typeof(string), typeof(MvvmBehaviors), new PropertyMetadata(null));</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code> public static readonly DependencyProperty LoadedMethodNameProperty =
    DependencyProperty.RegisterAttached(&quot;LoadedMethodName&quot;,
    typeof(string), typeof(MvvmBehaviors), new PropertyMetadata(null, OnLoadedMethodNameChanged));</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>private static void OnLoadedMethodNameChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
    ...
    if (element != null)
    {
        ...
        element.Loaded += (s, e2) =&gt;
        {
            ...
            if (methodInfo != null) methodInfo.Invoke(viewModel, null);
                    ...
                    <p>To use this we need to go over to the CustomerListView add a namespace for the local namespace
                        wherever we put the Behavior definition:
                    </p>
                    <figure>
                        <pre class="prettyprint">xmlns:local=&quot&quot;clr-namespace:MVVMCommsDemo&quot;quot;</pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>local:MvvmBehaviors.LoadMethodName=&quot;LoadCustomers&quot;&gt;</code></pre>
                    ...
                    <p>Now that we are going to add a method that will fire later after construction when the Loaded event
                ...
                <pre class="prettyprint"><code>public async void LoadCustomers()
{
    ...
    Customers = new ObservableCollection&lt;Customer&gt;(await _repository.GetCustomersAsync());
                    ...
                    <figure>
                        <img src="./images/wpfmvvmindepth/Fig04-020.png"/>
                    ...
                    <figure>
                <pre class="prettyprint"><code>xmlns:i=&quot;http://schemas.microsoft.com/expression/2010/interactivity&quot;
...
&lt;/i:Interaction.Triggers&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>&lt;ei:CallMethodAction TargetObject=&quot;{Binding}&quot; MethodName=&quot;LoadCustomers&quot; /&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public class CustomerListViewModel : INotifyPropertyChanged</code></pre>
                ...
                <pre class="prettyprint"><code>public ObservableCollection&lt;Customer&gt; Customers
{
    ...
    set
    {
        if (_customers != value)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;Customers&quot;));
                ...
                <pre class="prettyprint"><code>&lt;Button Content=&quot;Change Customer&quot;
    ...
    Click=&quot;OnChangeCustomer&quot; /&gt;
                    ...
                    <figure>
                <pre class="prettyprint"><code>private void OnChangeCustomer(object sender, RoutedEventArgs e)
{
    ...
    cust.FirstName = &quot;Changed in background&quot;;
                    ...
                    <figure>
                        <pre class="prettyprint"><code>public class ShowNotificationMessageBehavior : Behavior&lt;ContentControl&gt;</code></pre>
                        <figcaption>Fig 04-029A</figcaption>
                    </figure>
                    <p>Next, using the propp code snippet, expose a property on the Behavior called Message of type string
                        which can be set on the ViewModel through data binding (which means it will need to be a Dependency
                        Property):
                    </p>
                    <figure>
                <pre class="prettyprint"><code>public string Message
{
...
public static readonly DependencyProperty MessageProperty =
    ...
    typeof(ShowNotificationMessageBehavior), new PropertyMetadata(null, OnMessageChanged));</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>private static void OnMessageChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
{
    var behavior = ((ShowNotificationMessageBehavior)d);</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>var behavior = ((ShowNotificationMessageBehavior)d);
behavior.AssociatedObject.Content = e.NewValue;
behavior.AssociatedObject.Visibility = Visibility.Visible;</code></pre>
                    ...
                    <figure>
                <pre class="prettyprint"><code>protected override void OnAttached()
{
...
&lt;/Grid&gt;</code></pre>
                    ...
                    <figure>
                        <pre class="prettyprint"><code>xmlns:i=&quot;http://schemas.microsoft.com/expression/2010/interactivity&quot;</code></pre>
                ...
                <pre class="prettyprint"><code>public class MainWindowViewModel : INotifyPropertyChanged
    {
        ...
        public event PropertyChangedEventHandler PropertyChanged = delegate { };
                    ...
                    <p>Because adding properties with the INPC pattern to them is so common I have my own code snippet to do
                        it which is propc:
                    </p>
                    <figure>
                <pre class="prettyprint"><code>private string _NotificationMessage;
    ...
    set
    {
        if (value != _NotificationMessage)
        {
            ...
            PropertyChanged(this, new PropertyChangedEventArgs(&quot;NotificationMessage&quot;));
                    ...
                    <p>Type is string, the name of the property is NotificationMessage and you can see that my code snippet
                    ...
                    <figure>
                <pre class="prettyprint"><code> _timer.Elapsed += (s, e) =&gt; NotificationMessage = &quot;At the tone the time will be: &quot; + DateTime.Now.ToLocalTime() + &quot; beep.&quot;;
_timer.Start();</code></pre>
                    ...
                    <figure>
                        <img src="./images/wpfmvvmindepth/Fig04-036.png"/>
                    ...
                    <p>In the next module we'll finish out the structural topics you need to understand to apply MVVM
...
<script>
    export default {
        name: "WPFMVVMInDepth04ViewViewModelCommunicationInWPF"
    }
</script>
