...
export const routes = [
    ...
    {
        path: '/wpf-databinding-in-depth-04-binding-core-concepts', components: {
            default: WPFDatabindingInDepth04BindingCoreConcepts,
            'header-top': Header
        }
    },
    {
        path: '/wpf-databinding-in-depth-05-unleashing-the-full-power-of-bindings', components: {
            default: WPFDatabindingInDepth05UnleashingTheFullPowerOfBindings,
            'header-top': Header
        }
    },
    {
        path: '/wpf-databinding-in-depth-06-deep-dive-into-data-templates', components: {
            default: WPFDatabindingInDepth06DeepDiveIntoDataTemplates,
            'header-top': Header
        }
    },
    {
        path: '/wpf-databinding-in-depth-07-design-time-data-binding', components: {
            default: WPFDatabindingInDepth07DesignTimeDatabinding,
            'header-top': Header
        }
    },
    {
        path: '/wpf-databinding-in-depth-08-containers-and-collection-controls', components: {
            default: WPFDatabindingInDepth08ContainersAndCollectionsControls,
            'header-top': Header
        }
    },
    {
        path: '/wpf-databinding-in-depth-09-data-input-validation', components: {
    ...
    {
        path: '/wpf-mvvm-in-depth-00-course-contents', components: {
            default: WPFMVVMInDepth00CourseContents,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-01-mvvm-pattern-fundamentals', components: {
            default: WPFMVVMInDepth01MVVMPatternFundamentals,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-02-first-taste-of-mvvm', components: {
            default: WPFMVVMInDepth02FirstTasteOfMVVM,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-03-hooking-up-views-and-viewmodels-in-mvvm', components: {
            default: WPFMVVMInDepth03HookingUpViewsAndViewModelsInMVVM,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-04-view-viewmodel-communication-in-wpf', components: {
            default: WPFMVVMInDepth04ViewViewModelCommunicationInWPF,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-05-applied-mvvm-part-1-hierarchies-and-navigation', components: {
            default: WPFMVVMInDepth05AppliedMVVMPart1HierarchiesAndNavigation,
            'header-top': Header
        }
    },
    {
        path: '/wpf-mvvm-in-depth-06-applied-mvvm-part-2-validation-and-dependency-injection', components: {
    ...
    {
        path: '/xamarin-forms-cross-platform-01-getting-started', components: {
            default: XamarinFormsCrossPlatform01GettingStarted,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-02-xaml-essentials', components: {
            default: XamarinFormsCrossPlatform02XamlEssentials,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-03-layouts', components: {
            default: XamarinFormsCrossPlatform03Layouts,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-04-images', components: {
            default: XamarinFormsCrossPlatform04Images,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-05-lists', components: {
            default: XamarinFormsCrossPlatform05Lists,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-06-navigation', components: {
            default: XamarinFormsCrossPlatform06Navigation,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-07-forms-and-settings-pages', components: {
            default: XamarinFormsCrossPlatform07FormsAndSettingsPages,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-08-data-access', components: {
            default: XamarinFormsCrossPlatform08DataAccess,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-09-model-view-viewmodel-architectural-pattern', components: {
            default: XamarinFormsCrossPlatform09ModelViewViewModelArchitecturalPattern,
            'header-top': Header
        }
    },
    {
        path: '/xamarin-forms-cross-platform-10-beyond-the-basics', components: {
